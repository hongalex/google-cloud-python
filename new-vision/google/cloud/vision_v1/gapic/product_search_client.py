...
class ProductSearchClient(object):
    ...
    def create_product(self,
        ...
        return self._inner_api_calls['create_product'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def list_products(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_products'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
    ...
    def get_product(self,
        ...
        return self._inner_api_calls['get_product'](request,
                                                    retry=retry,
                                                    timeout=timeout,
                                                    metadata=metadata)
    ...
    def update_product(self,
        ...
        return self._inner_api_calls['update_product'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def delete_product(self,
        ...
        self._inner_api_calls['delete_product'](request,
                                                retry=retry,
                                                timeout=timeout,
                                                metadata=metadata)
    ...
    def get_reference_image(self,
        ...
        return self._inner_api_calls['get_reference_image'](request,
                                                            retry=retry,
                                                            timeout=timeout,
                                                            metadata=metadata)
    ...
    def delete_reference_image(self,
        ...
        self._inner_api_calls['delete_reference_image'](request,
                                                        retry=retry,
                                                        timeout=timeout,
                                                        metadata=metadata)
    ...
    def create_product_set(self,
        ...
        return self._inner_api_calls['create_product_set'](request,
                                                           retry=retry,
                                                           timeout=timeout,
                                                           metadata=metadata)
    ...
    def get_product_set(self,
        ...
        return self._inner_api_calls['get_product_set'](request,
                                                        retry=retry,
                                                        timeout=timeout,
                                                        metadata=metadata)
    ...
    def update_product_set(self,
        ...
        return self._inner_api_calls['update_product_set'](request,
                                                           retry=retry,
                                                           timeout=timeout,
                                                           metadata=metadata)
    ...
    def delete_product_set(self,
        ...
        self._inner_api_calls['delete_product_set'](request,
                                                    retry=retry,
                                                    timeout=timeout,
                                                    metadata=metadata)
    ...
    def add_product_to_product_set(
        ...
        self._inner_api_calls['add_product_to_product_set'](request,
                                                            retry=retry,
                                                            timeout=timeout,
                                                            metadata=metadata)
